...
##########################################################################################################
# Residual Generator and Discriminator.   
##########################################################################################################
class ResidualGenerator(nn.Module):
    ...
    def forward(self, time_input):
        ...
        return time_output, latent_vector
...
if __name__ == '__main__':
    ...
    # Forward pass
    time_output,_ = G(time_input)
    output = D(time_input)

    print("_"*32)
    print("Time Domain Models.")
    print(f"Time output shape: {time_output.shape}")  # Expected: [1, 2, 1024]
    print(f"Descriminator output shape: {output.shape}") 
    print("_"*32)
