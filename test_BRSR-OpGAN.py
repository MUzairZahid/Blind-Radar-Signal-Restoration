...
def main():
    ...
    model_configs_info = {
        'CNN-GAN (Time Domain)': {
            'paths': ['trained_models/CNN_GAN_Time_Domain.pth'],
            'q': 1
        },
        'CNN-GAN (Dual Domain)': {
            'paths': ['trained_models/CNN_GAN_Dual_Domain.pth'],
            'q': 1
        },
        'BRSR-OpGAN (Q=3, Time Domain)': {
            'paths': ['trained_models/BRSR_OpGAN_Q3_Time_Domain.pth'],
            'q': 3
        },
        'BRSR-OpGAN (Q=3, Dual Domain)': {
            'paths': ['trained_models/BRSR_OpGAN_Q3_Dual_Domain.pth'],
            'q': 3
        },
        'BRSR-OpGAN (Q=3, Dual Domain, 2nd Pass)': {
            'paths': [
                'trained_models/BRSR_OpGAN_Q3_Dual_Domain.pth',
                'trained_models/BRSR_OpGAN_Q3_Dual_Domain_2ndPass.pth'
            ],
            'q': 3
        }
    }
